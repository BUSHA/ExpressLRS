...
const fhss_config_t domains[] = {
    ...
    //MAFIA
    {"M-433",  FREQ_HZ_TO_REG_VAL(430000000), FREQ_HZ_TO_REG_VAL(436000000), 40, 433000000},
    {"M-485",  FREQ_HZ_TO_REG_VAL(482000000), FREQ_HZ_TO_REG_VAL(488000000), 40, 485000000},
    {"M-500",  FREQ_HZ_TO_REG_VAL(498000000), FREQ_HZ_TO_REG_VAL(503000000), 40, 500000000},
    {"M-730",  FREQ_HZ_TO_REG_VAL(718300000), FREQ_HZ_TO_REG_VAL(741700000), 40, 730000000},
    {"M-750",  FREQ_HZ_TO_REG_VAL(738300000), FREQ_HZ_TO_REG_VAL(761700000), 40, 750000000},
    {"M-780",  FREQ_HZ_TO_REG_VAL(768300000), FREQ_HZ_TO_REG_VAL(791700000), 40, 780000000},
    {"M-800",  FREQ_HZ_TO_REG_VAL(788300000), FREQ_HZ_TO_REG_VAL(811700000), 40, 800000000},
    {"M-830",  FREQ_HZ_TO_REG_VAL(818300000), FREQ_HZ_TO_REG_VAL(841700000), 40, 830000000},
    {"M-960",  FREQ_HZ_TO_REG_VAL(948300000), FREQ_HZ_TO_REG_VAL(971700000), 40, 960000000},
    {"M-1000", FREQ_HZ_TO_REG_VAL(988300000), FREQ_HZ_TO_REG_VAL(1011700000), 40, 1000000000},
    //PEGAS
    {"P-750",  FREQ_HZ_TO_REG_VAL(738300000), FREQ_HZ_TO_REG_VAL(761700000), 40, 750000000},
    {"P-960",  FREQ_HZ_TO_REG_VAL(948300000), FREQ_HZ_TO_REG_VAL(971700000), 40, 960000000},
    //SHRIKE
...
const fhss_config_t domains[] = {
    ...
    // #endif
    {"ISM2G4", FREQ_HZ_TO_REG_VAL(2400400000), FREQ_HZ_TO_REG_VAL(2479400000), 80, 2440000000},
    {"M-2.1", FREQ_HZ_TO_REG_VAL(2100400000), FREQ_HZ_TO_REG_VAL(2179400000), 80, 2140000000},
    {"M-2.2", FREQ_HZ_TO_REG_VAL(2200400000), FREQ_HZ_TO_REG_VAL(2279400000), 80, 2240000000},
    {"M-2.3", FREQ_HZ_TO_REG_VAL(2300400000), FREQ_HZ_TO_REG_VAL(2379400000), 80, 2340000000},
    {"M-2.5", FREQ_HZ_TO_REG_VAL(2500400000), FREQ_HZ_TO_REG_VAL(2579400000), 80, 2540000000},
