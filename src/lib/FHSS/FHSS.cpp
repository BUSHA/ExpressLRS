...
const fhss_config_t domains[] = {
    ...
    //MAFIA
    {"M-433",  FREQ_HZ_TO_REG_VAL(430000000), FREQ_HZ_TO_REG_VAL(436000000), 40},
    {"M-485",  FREQ_HZ_TO_REG_VAL(482000000), FREQ_HZ_TO_REG_VAL(488000000), 40},
    {"M-500",  FREQ_HZ_TO_REG_VAL(498000000), FREQ_HZ_TO_REG_VAL(503000000), 40},
    {"M-730",  FREQ_HZ_TO_REG_VAL(718300000), FREQ_HZ_TO_REG_VAL(741700000), 40},
    {"M-750",  FREQ_HZ_TO_REG_VAL(738300000), FREQ_HZ_TO_REG_VAL(761700000), 40},
    {"M-780",  FREQ_HZ_TO_REG_VAL(768300000), FREQ_HZ_TO_REG_VAL(791700000), 40},
    {"M-800",  FREQ_HZ_TO_REG_VAL(788300000), FREQ_HZ_TO_REG_VAL(811700000), 40},
    {"M-830",  FREQ_HZ_TO_REG_VAL(818300000), FREQ_HZ_TO_REG_VAL(841700000), 40},
    {"M-960",  FREQ_HZ_TO_REG_VAL(948300000), FREQ_HZ_TO_REG_VAL(971700000), 40},
    {"M-1000",  FREQ_HZ_TO_REG_VAL(988300000), FREQ_HZ_TO_REG_VAL(1011700000), 40},
    //PEGAS
    {"P-750",  FREQ_HZ_TO_REG_VAL(738300000), FREQ_HZ_TO_REG_VAL(761700000), 40},
    {"P-960",  FREQ_HZ_TO_REG_VAL(948300000), FREQ_HZ_TO_REG_VAL(971700000), 40},
    //SHRIKE
    ...
    //SPECIAL
    {"I-400",  FREQ_HZ_TO_REG_VAL(397000000), FREQ_HZ_TO_REG_VAL(403000000), 40},
    {"I-470",  FREQ_HZ_TO_REG_VAL(467000000), FREQ_HZ_TO_REG_VAL(473000000), 40}
